...
export default function Waitlist({ isGithub=false, isVSCode=false }: {
  ...
  return (
    <section className={cn(
      "min-h-[30rem] bg-white custom-container flex flex-col items-center md:pt-0 lg:flex-row lg:space-x-16 justify-between",
      isGithub || isVSCode ? "py-[5rem] lg:pt-[3rem]" : ""
    )}>
        <div className="w-full custom-container px-[2rem] lg:w-[50%] flex flex-col">
            ...
            <div className="mt-4 mx-auto md:w-3/4 lg:mx-0">
                <WaitlistForm />            
            </div>
        </div>
