...
export default function Hero() {
  return (
    <section className="bg-white flex items-center mt-[2rem] pt-[2rem] pb-[5rem] flex-col md:mt-0 md:flex-row lg:space-x-16 justify-between">
        <div className="w-full custom-container flex flex-col px-[2rem] sm:px-[2rem] md:mt-16 lg:px-0 lg:w-[50%] lg:mt-24">
