...
export default function Protection() {
  return (
    <div className="w-full min-h-[33rem] mb-[4rem] mt-[2rem] lg:mb-[6rem] relative">
        ...
        <div className="absolute bottom-0 mt-[100px] ml-[-50%] h-[550px] w-[200%] rounded-t-[100%] bg-[#f9f9f9]" />
        {/* <Image 
            src={BackImage}
        ...
        <Container>
            <div className="z-40 flex flex-col items-center mt-10">
                <div className='z-20 flex flex-col items-center lg:mt-16'>
                ...
                <div className="z-20 flex flex-col lg:flex-row justify-center items-center mt-10 px-3 gap-6 lg:gap-14">
                    <div className="bg-teal-500 p-2 m-2 rounded-lg w-full md:w-3/4 lg:h-[13rem] xl:w-1/3 xl:h-[15rem]">
